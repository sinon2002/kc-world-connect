...
export function TrustStats() {
  const [trustStats] = useContentSection("trustStats");
    ...
    <section id="trust-stats" className="section-pad bg-background">
      <div className="shell">
        <Reveal className="relative overflow-hidden rounded-[2.5rem] bg-[#0078C3] px-6 py-12 sm:px-10 md:px-14 md:py-16">
          ...
          <div aria-hidden="true" className="pointer-events-none absolute -top-24 right-16 size-[340px] rounded-full border-[40px] border-white/15" />
          <div aria-hidden="true" className="pointer-events-none absolute -bottom-10 -right-24 h-28 w-[520px] rotate-[-15deg] rounded-full bg-gradient-to-r from-transparent via-white/15 to-transparent" />
          ...
          <div className="relative z-10">
            ...
            <p className="mt-2 text-sm font-semibold uppercase tracking-wide text-white/75">
              {trustStats.subheading}
            </p>

            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {trustStats.items.map((s, i) => (
