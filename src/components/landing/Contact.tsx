...
Интересующая страна: ${
  ...
  return (
   <section id="consult" className="relative overflow-hidden section-pad text-white" style={{ background: "#0078c3" }}>
      {/* Сетка */}
