...
Интересующая страна: ${
  ...
  return (
    <section id="consult" className="relative rounded-t-[56px] section-pad text-white sm:rounded-t-[100px]" style={{ background: "#0078c3" }}>
      {/* Сетка */}
