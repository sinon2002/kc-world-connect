...
export function Faq() {
  ...
  return (
    <section id="faq" className="bg-cream section-pad overflow-hidden">
      {/* Контейнер shell теперь является относительным (relative), чтобы знаки равнялись по нему, а не по краям экрана */}
      <div className="shell relative">
        
        {/* Левый декоративный восклицательный знак (ближе к центру) */}
        <div 
          className="absolute left-[-10%] select-none pointer-events-none hidden xl:block" 
          style={{
            top: '40%',
            fontSize: '280px',
            fontWeight: 900,
        ...
        {/* Правый декоративный вопросительный знак (ближе к центру, кривой) */}
        <div 
          className="absolute right-[-10%] select-none pointer-events-none hidden xl:block" 
          style={{
            top: '45%',
            fontSize: '300px',
            fontWeight: 900,
